...
<br>
<form action="../datosTabla/create" method="POST" id="form_agrega_datosTabla" class="top-buffer">
    @csrf
        ...
        <tbody id="tabla_uno">
            @foreach ($docentesTabla as $tabla)
                <tr>
                    ...
                    <td>
                        <form action="{{$tabla->id}}/{{$tabla->rfc}}" method="POST" id="form_eliminar_datosTabla">
                            @csrf
                            @method('delete')
