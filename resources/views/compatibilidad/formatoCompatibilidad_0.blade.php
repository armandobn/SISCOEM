<form class="form" id="form_datos">
  ...
  <div class="row text-center">
      <div class="col-md-5">
          ...
          <div class="form-group">
              <input class="form-control text-center" id="director_cetis" name="director_cetis"
                  placeholder="DIRECTOR DEL CETIS No. 167" type="text" readonly
      ...
      <div class="col-md-7">
          ...
          <p style="border-bottom: 3px solid black; margin-top:11px">DIRECCION GENERAL DE RECURSOS HUMANOS Y
              ORGANIZACIÓN</p>
          PUESTO DEL SERVIDOR PÚBLICO
          <label class="form-control text-center" style="border-bottom: 3px solid black; margin-top:8px"></label>
          NOMBRE Y FIRMA
      </div>
  </div>
