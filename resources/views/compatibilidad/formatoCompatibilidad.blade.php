...
@section('content')
    ...
    <form action="{{route('formatoCompatibilidad.create')}}" method="post" id="form_formatoCompatibilidad">
        @csrf
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group datepicker-group">
                    ...
                    <input class="form-control" id="fecha_inicio_inst_uno" name="fecha_inicio_inst_uno" type="text"
                        disabled>
            ...
            <div class="col-md-4">
                <div class="form-group datepicker-group">
                    ...
                    <input class="form-control" id="fecha_termino_inst_uno" name="fecha_termino_inst_uno" type="text"
                        disabled>
                    <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group datepicker-group">
                    ...
                    <input class="form-control" id="fecha_inicio_inst_dos" name="fecha_inicio_inst_dos" type="text"
                        disabled>
                    <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group datepicker-group">
                    ...
                    <input class="form-control" id="fecha_termino_inst_dos" name="fecha_termino_inst_dos" type="text"
                        disabled>
                    <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
                </div>
            </div>
